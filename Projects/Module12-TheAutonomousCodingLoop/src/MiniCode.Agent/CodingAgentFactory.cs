...
public static class CodingAgentFactory
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var guard = new LoopGuardInvoker(new DirectToolInvoker());
        var catalog = new ToolCatalog(workspace, files, inspector, shell, guard);
        ...
        return new CodingAgent(agent, session, chatClient, composed, new Planner(chatClient, instructions.Load()), guard);
    }
}
