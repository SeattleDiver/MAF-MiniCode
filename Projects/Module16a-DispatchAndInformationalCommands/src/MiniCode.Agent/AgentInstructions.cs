...
public static class AgentInstructions
{
    ...
    public const string Core =
        ...
        + "deserves the same attention as the one you started with. Use git_status "
        + "and git_diff to see what has actually changed before writing a change "
        + "report, rather than reasoning from memory of what you edited; use git_log "
        + "for recent history. These tools only read the repository — nothing here "
        + "commits, pushes, or otherwise changes what Git tracks.";
