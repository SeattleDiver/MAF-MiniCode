    ...
    IToolInvoker invoker)
{
    ...
    public IReadOnlyList<AITool> GetTools()
    {
        ...
        var gitTools = new GitTools(git, workspace);
        ...
        [
            ...
            Intercept(AIFunctionFactory.Create(
                gitTools.GitStatus,
                name: "git_status",
                description: "Lists modified, added and untracked files against the current branch.")),
            Intercept(AIFunctionFactory.Create(
                gitTools.GitDiff,
                name: "git_diff",
                description: "Shows unstaged changes to tracked files, in unified diff format.")),
            Intercept(AIFunctionFactory.Create(
                gitTools.GitLog,
                name: "git_log",
                description: "Shows the most recent commits, newest first, one line each.")),
        ];
    }
