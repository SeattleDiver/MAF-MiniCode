...
public static class CodingAgentFactory
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var shell = new MiniCode.Infrastructure.ShellExecutor();
        var catalog = new ToolCatalog(workspace, files, inspector, shell, new DirectToolInvoker());
        ...
        return new CodingAgent(agent, session, chatClient, composed, new Planner(chatClient, instructions.Load()));
    }
}
